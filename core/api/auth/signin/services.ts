 ...
 */
export async function signin(data: SigninRequest): Promise<AuthResponse | EmailVerificationResponse> {
  const response = await apiClient<AuthResponse | EmailVerificationResponse>("/api/v1/auth/signin", {
    method: "POST",
