...
// import type { VerifyEmailRequest } from '@/core/api/auth/verify-email/types'
// import { useVerifyEmail } from '@/core/api/auth/verify-email/queries'
...
//   // Redirect to signin if token is missing (must be in useEffect to avoid render error)
//   useEffect(() => {
//     if (!token) {
//       router.push('/signin')
//     }
//   }, [token, router])
//   const { mutateAsync, isPending, isError, error, isSuccess } = useVerifyEmail()

//   // Get email from sessionStorage (stored during signup) or URL params as fallback
//   // Using lazy initializer to avoid calling setState in useEffect
